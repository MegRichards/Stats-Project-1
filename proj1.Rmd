...
<!-- Include write up here --> Include that I changed color palette because the standard was too much like a rainbow and gradient and adjusted scale of facet to show range better and meaningful title for animation
...
ggplot(
  ...
  labs(
    ...
    subtitle = paste("Animation to show points achieved cumulatively by the top 5 drivers throughout the season"),
    x = "Race name",
    y = "Cumulative Points")+
...
ggplot(
  ...
  labs(
    ...
    x = "Race Name",
    y = "Cumulative Points")+
  scale_fill_discrete(name = "Constructor")
```
