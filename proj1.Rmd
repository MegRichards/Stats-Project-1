...
driver_cum_points_top5 = driver_cum_points%>%
  filter(driver == "Lewis Hamilton" | driver ==  "Valtteri Bottas" |driver == "Max Verstappen" |driver == "Charles Leclerc"| driver == "Sebastian Vettel")
...
#repeat for constructor, then do just top 5 or something and animate the constructors?
